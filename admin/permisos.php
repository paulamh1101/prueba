<?php
	...
	$categoriasUsuario = getCategoriasUsuario($usuario);
...
<html lang="es">
  ...
  <body>
	...
	<div class="row">
    <ol class="breadcrumb">
	<li><a href="../panelAdmin.php"><i class="fa fa-home"></i>Panel Administrador</a></li>
	</ol>
	<h1  align=center>Bienvenido,Administrador</h1>
        <p  align=center class="lead">Se està modificando permisos de acceso:<?=$usuario?></p>
        <div class="row">
            ...
            <div class ="panel-body">
              <form action="../scripts/actualizarPermisos.php" method="POST">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="txtUsuario" name="txtUsuario" value="<?=$_GET['usuario']?>">
                </div>
				...
				foreach ($categorias as $categoria): 
					...
					$respuesta = mysqli_query($conexion,"SELECT * FROM  permisos where usuario='".$usuario."' and id_categoria = ".$categoria[0]."");
					
						if ($respuesta->num_rows > 0)
						{
							while ($row=mysqli_fetch_array($respuesta))
							{//inicio while
								echo '<input type="checkbox" name="categoria[]" id="categoria[]" value='.$categoria[0].' checked>'.$categoria[1].'<br>';
							}
						}else{
							echo '<input type="checkbox" name="categoria[]" id="categoria[]" value='.$categoria[0].'>'.$categoria[1].'<br>';
						}
                endforeach;
				desconectar();
				?>	
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-4">
          <h4><a href ="../admin/permisos.php"><font color= #5a471d>Permisos</a></h4>
          <p>Permiten asignar permisos a los archivos para determinados usuarios y grupos de uauarios. </p>
         
        </div>
        <div class="col-md-4">
          <h4><a href ="../admin/categoria.php"><font color= #5a471d>Categorias</a></h4>
          <p><p>Acceso a las diversas categorias que el usuario tiene permiso.</p> </p>
         
       </div>
        <div class="col-md-4">
          <h4><a href ="../admin/reportes.php"><font color= #5a471d>Reportes</a></h4>
