     ...
     <?php } else {
        ...
        <?php } else {
          ...
          <?php } else {
            ...
            $insertar = mysqli_query($connect, "INSERT INTO usuarios (nombre,avatar,email,usuario,contrasena,fecha_reg) values ('$nombre','defect.jpg','$email','$usuario','$contrasena',now())");
