            ...
            <div class="box-body no-padding">
              <div class="table-responsive mailbox-messages">
                <table class="table table-hover table-striped">
                  ...
                  <?php
                  $chats = mysqli_query($connect, "SELECT * FROM c_chats WHERE de = '".$_SESSION['id']."' OR para = '".$_SESSION['id']."' order by id_cch desc");
                  while($ch = mysqli_fetch_array($chats)) { 
                    ...
                    $chat = mysqli_query($connect, "SELECT * FROM chats WHERE id_cch = '".$ch['id_cch']."' ORDER BY id_cha desc limit 1");
